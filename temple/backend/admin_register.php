...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($row[0] > 0) 
	{
        echo "Error: User with this email address already exists.";
    } 
	else 
	{
		...
		if(isset($_POST['register']))
		{
			...
			$sql="insert into admin(name,email,contact,password,image)values('$name','$email','$contact','$password','$filename')";
