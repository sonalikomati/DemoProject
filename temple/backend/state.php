                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="padding:20px 10px 0 10px;"><i class="fa fa-trash-alt me-2" style='color:red;padding-left:15px'></i></td>
                                        <td style="padding:20px 10px 0 10px;"><a href="gallery_update.php"><i class="fa fa-edit me-2" style='color:green;padding-left:15px'></i></a></td>
                                    </tr>
                                </tbody>
                                <?php
                                }
